...
$(document).ready(function(){
    $(".btnContinue").click(function(e){
     ...
     $("#continue").click(function(event) {
      ...
      //check out
      $("#takeOut").click(function() {
          alert("Dear your take out will be ready for pickup in 15 minutes. Total amount expected: " + total + "Thank you for choosing LaFliq Pizza Cafe!");
      ...
      $("#checkout").click(function() {
          ...
          if (personName === "" || clientNumber === "" || clientLocation === "") {
              ...
              alert("Dear " + personName + "Thank you for choosing LaFliq Pizza Cafe! Your order has been successfully queued,and will be delivered at: " + clientLocation + " in 30 minutes! The total for is: " +
                  grandTotal);
          }
      })
  })
